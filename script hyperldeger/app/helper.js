...
// data mongo (harus diubah)
const registerUserMongo = async (req, res) => {
  // var { noHP, nama, username, password, ttl, noKK, noNPWP, nik, orgName, luasLahanHa, alamatToko, alamatLahan, kelompokTani } = req.body;
  var { userName, password: plainTextPassword, email, namaLengkap, noTelp, tglLahir, nik, role, alamat } = req.body;
